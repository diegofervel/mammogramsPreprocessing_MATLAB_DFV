function results = FuncProcesamientoMamografiasSinComen(I)
...
sumFirst = sum(cropImage(:,1:20)); %nC-20
sumLast = sum(cropImage(:,nC-19:nC)); %nC-19
if sumFirst>sumLast
    orientation = 'right';
...
%% FINAL CROP
% Línea comentada en febrero de 2021: defini = imresize(defini,[512 512]);
figure(2)
imshow(defini);title('Final Image');
